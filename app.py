...
info = Info(title="ToiGet API", version="1.0.0")
...
toilet_tag = Tag(name="Toilet", description="Insert, view and delete toilets")
...
def get_toilet(query: ToiletBuscaSchema):
...
def del_toilet(query: ToiletBuscaSchema):
